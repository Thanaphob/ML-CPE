...
* ในไฟล์ `test_nn.py` ได้เปลี่ยนจากการพล็อตภาพ Grid 2x2 ด้วย `ax.imshow()` มาเป็นการสุ่มหยิบตัวอย่างตารางขึ้นมาทำนายผล และพิมพ์ตารางสรุป `Predicted`, `True`, `Confidence Score` ผ่าน Terminal

---

## วิธีการทดสอบผลลัพธ์ (How to Run)

```bash
# 1. ติดตั้ง Library ที่ต้องใช้
pip install tensorflow pandas scikit-learn matplotlib numpy

# 2. เข้าโฟลเดอร์และสั่งรัน Pipeline การเทรนและการประเมินผล
cd classification
python main.py

# 3. สั่งรันการทดสอบสุ่มทำนายข้อมูล
python test_nn.py
